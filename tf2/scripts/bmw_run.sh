python3 run.py --dataset=bmw --data_dir="/home/nick/bmw_data" --eval_split=test \
--use_tpu=False --model_dir=logs --mode=train --train_mode=pretrain --image_size=224 \
--image_size=224 --train_batch_size=128 --lineareval_while_pretraining=False
