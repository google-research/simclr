python3 run.py --dataset=mvtech --data_dir="/mnt/data" --eval_split=train --use_tpu=False --model_dir=logs --train_mode=pretrain --image_size=224,224 --train_batch_size=128
